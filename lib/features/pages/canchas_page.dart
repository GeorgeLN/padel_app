        ...
        builder: (context, snapshot) {
          ...
          return StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, canchaSnapshot) {
              ...
              final canchas = canchaSnapshot.data!.docs
                  .map((doc) => Cancha.fromFirestore(doc))
                  .toList();
              final cancha = canchas.firstWhere((c) => c.nombre == quedada.lugar, orElse: () => Cancha(id: '', nombre: '', direccion: '', cantidad: 0, disponibles: 0));

              return ListView.builder(
                itemCount: cancha.cantidad,
